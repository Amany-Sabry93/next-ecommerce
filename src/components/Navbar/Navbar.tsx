              ...
              <NavigationMenu className="hidden  sm:flex">
                <NavigationMenuList>
                  ...
                  <NavigationMenuItem>
                    <NavigationMenuLink
                      asChild
                      className="text-gray-500 dark:text-gray-100 text-md sm:text-2xl "
                    >
                      <Link
                        href="/products"
                ...
                <NavigationMenuList>
                  <div className=" flex flex-row items-center">
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuLink
                        asChild
                        className="hover:bg-transparent block dark:hidden"
                      >
                        <Moon
                          onClick={() => {
                            setTheme("dark");
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuLink
                        asChild
                        className="hover:bg-transparent hidden dark:block"
                      >
                        <Sun
                          onClick={() => {
                            setTheme("light");
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuLink
                        asChild
                        className="hover:bg-transparent  hover:fill-fuchsia-500 "
                      >
                        <Link
                          href="/wishlist"
                          className=" focus:text-white  hover:text-white mr-3 "
                        >
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger >
                      <User className=" text-gray-500 dark:text-gray-100 size-8" />
                    </DropdownMenuTrigger>
                    <DropdownMenuContent>
                      <DropdownMenuGroup>
                  ...
                  {data ? (
                    <>
                      <NavigationMenuItem>
                        <NavigationMenuLink
                          asChild
                          className="hover:bg-transparent flex-row items-center   "
                        >
                          <div className="relative">
                            ...
                            <div className=" w-5 h-5 bg-gray-500 text-sm text-white rounded-full flex justify-center items-center absolute bottom-7 left-5   ">
                              {context?.numOfCartItems != null && (
                                <h5>{context.numOfCartItems}</h5>
                              )}
                            </div>
